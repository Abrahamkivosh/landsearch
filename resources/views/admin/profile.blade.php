          ...
          <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
                <b>Clerks</b> <a class="pull-right">62</a>
              </li>
              <li class="list-group-item">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <p>
              ...
              <span class="label label-success">Organizing</span>
      ...
      <div class="col-md-9">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class=" action active disabled"><a href="#activity" data-toggle="tab">Activity</a></li>
            <li class=" disabled" ><a href="#timeline" data-toggle="tab">Timeline</a></li>
            <li ><a class=" action " href="#settings" data-toggle="tab">Settings</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="settings">
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="job_title" class="col-sm-2 control-label">Skills</label>
